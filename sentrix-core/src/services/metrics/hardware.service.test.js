...
describe("Hardware Service - Peripheral Tracking", () => {
  ...
  it("should mark a peripheral as missing immediately when it is removed from a snapshot", async () => {
    ...
    const mockExistingRows = [
      {
        ...
        vendor: "Logitech",
        status: "connected",
        last_seen_at: now, // Verified immediately without status dampening
      },
    ];
