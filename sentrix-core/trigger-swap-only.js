...
const clientId = "0c3e4cf6-bb6f-4291-a569-ef971ea5ad88";
...
const options = {
  hostname: 'localhost',
  port: 4000,
  path: `/api/clients/${clientId}/command`,
  method: 'POST',
...
console.log(`Sending direct client command 'update' to https://localhost:4000/api/clients/${clientId}/command...`);
